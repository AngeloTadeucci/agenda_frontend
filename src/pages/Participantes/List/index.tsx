      ...
      <form>
        ...
        <div className="field-group">
          <div className="field">
            ...
            <input
              onChange={(text) => setIdEvento(Number(text.currentTarget.value))}
              type="text"
              name="idevento"
              id="idevento"
            />
          ...
          <div className="field">
            ...
            <input
              onChange={(text) => setIdContato(Number(text.currentTarget.value))}
              type="text"
              name="idcontato"
              id="idcontato"
            />
        ...
        <div className="field-group">
          <div className="field">
            ...
            <input
              onChange={(text) => setConfirmacao(Number(text.currentTarget.value))}
              type="text"
              name="confirmacao"
              id="confirmacao"
            />
